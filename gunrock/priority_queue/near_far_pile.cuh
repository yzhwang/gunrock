...
struct PriorityQueue {
  ...
  struct NearFarPile {
    ...
    VertexId *d_valid_near; /**< array which shows whether an element is valid
                               in the near pile */
    VertexId *
        d_valid_far; /**< array which shows whether an element is valid in the
                        far pile */
  };
  ...
  PriorityQueue() : queue_length(0), max_queue_length(UINT_MAX), selector(0) {}
  ...
  cudaError_t Init(SizeT edges, double queue_sizing) {
    ...
    do {
      ...
      util::MemsetKernel <<<128, 128>>>
          (nf_pile[0]->d_valid_near, 0, max_queue_length);
      util::MemsetKernel <<<128, 128>>>
          (nf_pile[0]->d_valid_far, 0, max_queue_length);
