...
struct KernelPolicy {
  ...
  typedef gunrock::oprtr::edge_map_forward::KernelPolicy<
      _ProblemData, _CUDA_ARCH, _INSTRUMENT, _MIN_CTA_OCCUPANCY, _LOG_THREADS,
      _LOG_LOAD_VEC_SIZE, _LOG_LOADS_PER_TILE, _LOG_RAKING_THREADS,
      _WARP_GATHER_THRESHOLD, _CTA_GATHER_THRESHOLD,
  ...
  typedef gunrock::oprtr::edge_map_partitioned::KernelPolicy<
      _ProblemData, _CUDA_ARCH, _INSTRUMENT, 1, _LOG_THREADS, _LOG_BLOCKS,
