...
struct CpuTimer {
  ...
  void Start() { getrusage(RUSAGE_SELF, &start); }

  void Stop() { getrusage(RUSAGE_SELF, &stop); }
...
void RefCPUBC(SizeT *row_offsets, VertexId *column_indices, Value *bc_values,
              SizeT num_nodes, VertexId src) {
...
template void RefCPUBC<int, float, int>(int *row_offsets, int *column_indices,
                                        float *bc_values, int num_nodes,
                                        int src);

template unsigned int RefCPUCC<int, int>(int *row_offsets, int *column_indices,
                                         int num_nodes, int *labels);
